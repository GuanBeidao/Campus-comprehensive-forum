...
public class PictureController {
     ...
     */
    @GetMapping
    public ResponseResult selectAll(Page<Picture> page, Picture picture) {
        return null;
    }
     ...
     */
    @PostMapping
    public ResponseResult insert(@RequestBody Picture picture) {
        return null;
    }
     ...
     */
    @PutMapping
    public ResponseResult update(@RequestBody Picture picture) {
        return null;
    }
